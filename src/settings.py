...
class DefaultArgParser(ArgumentParser):
    def __init__(self, *args, **kwargs):
        ...
        self.add_argument("--physics_true_adjoint", action=BooleanOptionalAction, default=False)
        ...
        self.add_argument("--SingleImageDataset__duplicates_count", type=int, default=800)
